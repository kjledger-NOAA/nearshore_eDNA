...
```{r}
salmon_tax <- read.delim("/home/kimberly.ledger/nearshore_eDNA/data/samples_w_mocks_updated/blastn_salmon.txt", header = FALSE, na.strings=c(""," ","NA"))
...
```
only a few differences between full ncbi db and custom salmon db. but will go ahead with the custom db verison. 
...
```{r}
write.csv(tax_df_updated, "/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/taxonomy_20250110_uncollapsed.csv")
write.csv(tax_df_updated_collapsed, "/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/taxonomy_20250110_collapsed.csv")
```
...
export 
```{r}
write.csv(tax_df_groups, "/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/taxonomy_groups_20250110.csv")
```

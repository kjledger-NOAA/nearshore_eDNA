...
in1 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in2_out1.Rdata")
in2 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in3_out2.Rdata")
in3 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in5_out1.Rdata")
in5 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in6_out2.Rdata")
in6 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in7_out6.Rdata")
in7 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in8_out1.Rdata")
in8 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in9_out6.Rdata")
in9 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in10_out1.Rdata")
in10 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in11_out1.Rdata")
in11 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in12_out7.Rdata")
in12 <- Output
load("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241126_in13_out1.Rdata")
in13 <- Output
```
...
```{r}
ggsave(p_clr, filename = "/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/figures/clr_all_mocks.png", width = 8, height = 5, units = "in")
```

```{r}
write.csv(clr_alpha_all, "/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/clr_all_mocks.csv")
```

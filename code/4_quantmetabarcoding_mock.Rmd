---
title: "Quantitative metabarcoding of AK nearshore mock community samples"
author:"Kimberly Ledger"
date: "2024-08-22"
output: github_document
---

notes to self from 11/12/24:
-need to rerun without com4 included 
-decide on a training/testing framework so that i'm not running this code a million times... 


this code is using the gblock mock communities from the 20240820 miseq run. and nov miseq run. 
input is updated (nov 2024) taxonomic assignment, etc 
...
```{r}
mockcom_data <- read.csv("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/ns_mock_20241112.csv") %>%
...
I've settled on three subsets of mock communities to set at the "known" samples to test. 
group1: 1,3,6,8,12,13
group2: 2,5,6,7,10,13
group3: 1,3,5,8,9,11
  
```{r}
#set all or some mock communities as unknowns 
env <- mockcom_data %>%  
  #filter(community %in% c("COM2", "COM3", "COM4", "COM5", "COM6", "COM7","COM8", "COM9", "COM10", "COM11", "COM12", "COM13")) %>%  
  filter(!community %in% c("COM1", "COM3", "COM6", "COM8", "COM12","COM13")) %>%  
...
```{r}
save(Output,file=paste0("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/raw_20241113_group1",".Rdata"))
```
...
```{r}
save(Output,file=paste0("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241113_group1",".Rdata"))
```

...
group3: 1,3,5,8,9,11                #### note to future self: maybe change group3 so it's not so similar to group 1
...
env <- mockcom_data %>%  
  ...
  filter(!community %in% c("COM1", "COM3", "COM5", "COM8", "COM8","COM11")) %>%  
...
```{r}
save(Output,file=paste0("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/raw_20241113_group3",".Rdata"))
```
...
```{r}
save(Output,file=paste0("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241113_group3",".Rdata"))
```

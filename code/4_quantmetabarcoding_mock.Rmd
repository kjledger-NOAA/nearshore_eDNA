...
group3: 1,2,5,8,9,11                #### note to future self: maybe change group3 so it's not so similar to group 1
...
```{r}
save(Output,file=paste0("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/raw_20241119_group1",".Rdata"))
```
...
```{r}
save(Output,file=paste0("/home/kimberly.ledger/nearshore_eDNA/outputs/samples_w_mocks_updated/mock_quant/mock_20241119_group1",".Rdata"))
```
